...
namespace game_jaaj_6.Gameplay
{
    public class Spike : Solid
    {
        ...
        public override void UpdateData(GameTime gameTime)
        {
            ...
            this.Position.Y = this.InitialPosition.Y + (float)Math.Cos(timer * _speed) * _interval;
            this.Position.Y = Math.Max(this.InitialPosition.Y - 4, this.Position.Y);
            this.Position.Y = Math.Min(this.InitialPosition.Y + 4, this.Position.Y);
